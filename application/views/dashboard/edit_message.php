				...
				<div class="row mx-1 mt-3 align-items-center">
					<div class="col-md-12 px-0">
						<div class="card noborder bg-white rounded shadow-sm">
							<div class="card-header bg-white font-weight-bold"><i class="align-middle fas fa-link mr-2"></i>ویرایش پیام</div>
							<div class="card-body text-secondary p-4">
								<form method="POST" action="{base_url}/dashboard/admin/message/validate_edit/<?=$message['id']?>">
										...
										<div class="col-md-12 mt-3">
											<div class="input-group mb-3">
											  <div class="input-group-prepend">
												...
												<input type="text" name="title" class="form-control <?php echo(array_key_exists('title', $errors))?'is-invalid':''; ?>" id="title" placeholder="عنوان را وارد کنید..." value="<?=$message['title']?>" required>
											</div>
										</div>
									</div>
									...
									<div class="form-row mb-3">
										<div class="col-md-12 mt-3">
											...
											<textarea rows="6" class="form-control <?php echo(array_key_exists('description', $errors))?'is-invalid':''; ?>" name="text" id="description" placeholder="" required><?=$message['text']?></textarea>
