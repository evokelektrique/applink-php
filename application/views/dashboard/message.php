									...
									<div class="form-row">
										<div class="col-md-12">
											<div class="d-flex mb-4">
												...
												<div class="input-group col-md-3 pr-0">
													<div class="input-group-prepend">
														<div class="input-group-text"style="min-width: 100%">وضعیت </div>
													</div>
													<input type="text" value="<?=$notification_status?>" disabled class="form-control" placeholder="وضعیت">
													<div class="input-group-append">
											...
											<div class="form-row mb-3">
												<div class="col-md-12 mt-3">
													<p class="message_text text-dark text-justify p-4 border rounded shadow-sm">
														{text}
													</p>
												</div>
											</div>
